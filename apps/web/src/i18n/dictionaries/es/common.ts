...
export const esCommon: Record<keyof typeof enCommon, string> = {
  ...
  'topbar.welcomeBack': 'Hola de nuevo,',
  ...
  'status.EscrowFunded': 'Fondos depositados',
  'status.InProgress': 'En curso',
  'status.ContractorDone': 'Trabajo terminado',
  'status.ClientConfirmed': 'Confirmado por el cliente',
