...
const SETTING_DEFS: SettingDef[] = [
  ...
  { key: 'referrer_signup_fee', label: 'Referrer Signup Fee ($)', description: 'One-time fee for referrer (non-contractor) accounts to register', type: 'number' },
  { key: 'referrer_commission_pct', label: 'Referrer Commission Rate (%)', description: 'Commission earned when the job poster is a referrer account', type: 'number' },
  { key: 'referrer_requires_subscription', label: 'Referrers Need Subscription', description: 'When ON — referrer accounts must hold an active monthly subscription to post referrals', type: 'boolean' },
